                    ...
                    <div class="col-xl-12 col-lg-12 col-md-12  pt-20">
                                    ...
                                    <div class="tpproductnav tpnavbar product-filter-nav d-flex align-items-center justify-content-center">
                                        <nav>
                                            <div class="nav nav-tabs" id="nav-tab" role="tablist">
                                                <button class="nav-link" :class="{'active' : viewListType == 'grid'}" @click="selectedListType('grid')" id="nav-all-tab" data-bs-toggle="tab" data-bs-target="#nav-all" type="button" role="tab" aria-controls="nav-all" aria-selected="true">
                                                    <i>
                                                ...
                                                <button class="nav-link" :class="{'active' : viewListType == 'list'}" @click="selectedListType('list')" id="nav-product-tab" data-bs-toggle="tab" data-bs-target="#nav-product" type="button" role="tab" aria-controls="nav-product" aria-selected="false" tabindex="-1">
                                                    <i>
                        ...
                        <div class="tab-content" id="nav-tabContent">
                            ...
                            <div class="tab-pane fade whight-product" :class="{'active show' : viewListType == 'list'}" id="nav-product" role="tabpanel" aria-labelledby="nav-product-tab">
                                <div class="row">
                                    <div class="col-lg-12"  v-for="product in products.data">
