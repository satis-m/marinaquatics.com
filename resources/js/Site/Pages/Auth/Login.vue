                    ...
                    <div class="tptrack__product mb-40">
                        <div class="tptrack__content grey-bg">
                            ...
                            <div class="tptrack__btn">
                                <button class="tptrack__submition active">Login Now<i class="icon-arrow-right"></i></button>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="col-lg-6 col-sm-12">
                    <div class="tptrack__product mb-40">
                        <div class="tptrack__content grey-bg">
                            ...
                            <div class="tptrack__btn">
                                <button class="tptrack__submition tpsign__reg">Register Now<i class="icon-arrow-right"></i></button>
                            </div>
                        </div>
                    </div>
                </div>
