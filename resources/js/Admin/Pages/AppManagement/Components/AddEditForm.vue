      ...
      <el-col :xs="24" :sm="24">
        <el-card class="box-card h-full">
          <el-row :gutter="20" class="mb-6">
            ...
            <el-col :xs="24" :sm="12" :md="8">
              <el-form-item label="Facebook Link" prop="fb_link">
                <el-input v-model="formData.fb_link"
                />
              </el-form-item>
            </el-col>
            <el-col :xs="24" :sm="12" :md="8">
              <el-form-item label="Youtube Link" prop="youtube_link">
                <el-input v-model="formData.youtube_link"
                />
              </el-form-item>
            </el-col>
            <el-col :xs="24" :sm="12" :md="8">
              <el-form-item label="Instagram Link" prop="insta_link">
                <el-input v-model="formData.insta_link"
                />
              </el-form-item>
            </el-col>
            <el-col :xs="24" :sm="12" :md="8">
              <el-form-item label="WhatsApp" prop="whatsapp_link">
                <el-input v-model="formData.whatsapp_link"
                />
              </el-form-item>
            </el-col>
          </el-row>
...
let populateFormData = function (data) {
  ...
  formData.fb_link = data.fb_link;
  formData.youtube_link = data.youtube_link;
  formData.insta_link = data.insta_link;
